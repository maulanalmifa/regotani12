...
<div class="container-fluid" style="background-color:#eee8d8; text-align: center; padding-top:10px;">
    ...
    $level=$data['status'];
    ?>
    <form method="post" action="../php_proses/proses_edit_profil.php">
    <div class="row justify-content-md-center">
    ...
    <div class="row justify-content-md-center">
        <div class="col-4">
            <div class="form-group" style="text-align:left;">
                ...
                <input id="displayName" name="displayName" class="form-control" type="text" placeholder="Name" value="<?php echo $data['nama'];?>">
            </div>   
        </div>
        <div class="col-2">
            <div class="form-group" style="text-align:left;">
                <label for="displayStatus">Status</label>
                <input id="displayStatus" name="displayStatus" class="form-control" type="text" placeholder="Status" value="<?php echo $data['status'];?>" readonly>
            </div>   
        </div>
    </div>
    <div class="row justify-content-md-center">
    ...
    <div class="row justify-content-md-center">
        <div class="col-6">
            <div class="form-group" style="text-align:left;">
                ...
                <input id="displayAddress" name="displayAddress" class="form-control" type="text" placeholder="Alamat" value="<?php echo $data['alamat'];?>">
            </div>   
        </div>
    </div>
    <div class="row justify-content-md-center">
        <div class="col-6">
            <div class="form-group" style="text-align:left;">
                <label for="displayPhone">Telepon</label>
                <input id="displayPhone" name="displayPhone" class="form-control" type="text" placeholder="Telepon" value="<?php echo $data['telepon'];?>">
            </div>   
        </div>
    </div>
    <?php
    ...
    <div class="row justify-content-md-center">
        <div class="col-6">
            <div class="form-group" style="text-align:left;">
                <label for="displayBasis">Basis Dagang</label>
                <input id="displayBasis" name="displayBasis" class="form-control" type="text" placeholder="Basis Dagang" value="<?php echo $data['basis_dagang'];?>">
            </div>   
        </div>
    </div>
    <?php }
    ...
    <div class="row justify-content-md-center">
        <div class="col-lg-2">
        <a href="../php_proses/proses_edit_profil.php?user=<?php echo $data['id_user']?>&as=<?php echo $data['status']?>"><button class="btn" name="simpan" style="background-color:#006c5c; border:none; color: #ffcc00; width:100px; border-radius: 10px;" type="submit">Simpan</button></a>
        </div>
        <div class="col-lg-2">
